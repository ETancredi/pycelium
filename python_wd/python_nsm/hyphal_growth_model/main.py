...
def setup_simulation(opts):
    ...
    if getattr(opts, "drug_field_enabled", False):
        ...
        # Optional outside-in square initial condition. This paints a drug-loaded
        # frame around all four edges of the square field, so diffusion advances
        # inward from the perimeter instead of right-to-left across the plate.
