...
class DensityGrid:
    ...
    def update_from_mycel(self, mycel: Mycel):
        ...
        """
        opts = mycel.options # Reset grid to zero before accumulating
        count = 0

        for section in mycel.get_all_segments(): # Iterate over all segments in simulation
            include = False # Include segment's end point
        ...
        print(f"🧮 DensityGrid updated with {count} contributing points.") # Log how many points contributed to the grid
